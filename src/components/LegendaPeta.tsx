...
export default function LegendaPeta() {
  ...
  return (
    <div className="absolute right-4 top-16 z-600 w-44 rounded-2xl border border-slate-200/80 bg-white/95 p-3 shadow-[0_18px_40px_rgba(15,23,42,0.14)] backdrop-blur-md">
